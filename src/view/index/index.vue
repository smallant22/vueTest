          ...
          <div class="row_left row_base">
            <el-col :span="12">
              <div class="pay saleBgcolor data_list rflex">
                <div class="leftItem cflex wflex">
                  <p class="investor">{{ ('index.yearLoss') }}</p>
                  <p class="number">68<span class="perTitle">({{ ('index.tenMillion') }})</span></p>
                </div>
                <div class="rightItem">
            ...
            <el-col :span="12">
              <div class="pay taxBgcolor data_list rflex">
                <div class="leftItem cflex wflex">
                  <p class="investor">{{ ('index.yearProfit') }}</p>
          ...
          <div class="row_right row_base">
            <el-col :span="6">
              <div class="extenedBgcolor data_list rflex">
                <div class="leftItem cflex wflex">
                  <p class="investor">{{ ('index.potentialInvestor') }}</p>
                  <p class="number">686<span class="perTitle">({{ ('index.person') }})</span></p>
            ...
            <el-col :span="6">
              <div class="likeBgcolor data_list rflex">
                <div class="leftItem cflex wflex">
                  <p class="investor">{{ ('index.intentionInvestor') }}</p>
                  <p class="number">1276<span class="perTitle">({{ ('index.person') }})</span></p>
            ...
            <el-col :span="6">
              <div class="linkBgColor data_list rflex">
                <div class="leftItem cflex wflex">
                  <p class="investor">{{ ('index.waitExamineInvestor') }}</p>
                  <p class="number">82367<span class="perTitle">({{ ('index.person') }})</span></p>
            ...
            <el-col :span="6">
              <div class="keleBgColor data_list rflex">
                <div class="leftItem cflex wflex">
                  <p class="investor">{{ ('index.examiningInvestor') }}</p>
                  <p class="number">827373<span class="perTitle">({{ ('index.person') }})</span></p>
